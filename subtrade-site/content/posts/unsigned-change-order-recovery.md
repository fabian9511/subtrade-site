...
tag: "Getting paid"
date: "2026-08-12"
image: "/unsigned-change-order-recovery-foreman-tablet.webp"
imageAlt: "A foreman standing in a partly framed commercial interior at dusk, photographing directed extra work on a tablet under temporary lighting."
---
...
A system built around [change order management](/construction-management-features/change-order-management/) from the sub's side does exactly this: it keeps the direction, the dated photo, the priced amount, and the status together, and it tells you which ones have gone quiet so you can push them before they age out.
...
Dated field evidence is what makes both stick. The [site photos](/construction-management-features/site-photos/) and [daily logs](/construction-management-features/daily-logs/) your crew is already capturing are your proof, as long as they are tied to the job and the date automatically instead of living in a phone's camera roll.
