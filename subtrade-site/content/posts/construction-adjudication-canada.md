...
tag: "Getting paid"
date: "2026-08-15"
image: "/construction-adjudication-canada-subcontractor-documents-review.webp"
imageAlt: "A subcontractor assembling payment records and contract documents at a desk to prepare an adjudication claim, laptop open beside the files."
---
...
The clearest trigger is prompt-payment non-payment. In Alberta an owner has 28 days to pay a proper invoice and a contractor has 7 days to pay its subs after being paid, with a Notice of Non-Payment required to dispute. When those deadlines pass and the money does not come, adjudication is how you force the issue. For the payment deadlines and the notice mechanics behind this, see our guide to [construction holdback by province](/blog/construction-holdback-by-province/).

It is also a route for the two things subs lose the most money on. Unapproved or unsigned change orders can be adjudicated as a valuation dispute, which is a real answer to the extras problem covered in [recovering unsigned change orders](/blog/unsigned-change-order-recovery/). And a holdback that is due but not being released can go to adjudication too, which is one of the fixes in our list of [reasons holdback gets released late](/blog/holdback-release-delays/).
...
You start by giving written notice of adjudication to the other party and to the nominating authority. In Alberta that authority is [ARCANA, run by the ADR Institute of Alberta](https://adralberta.com/prompt-payment/), which has been the designated construction adjudication nominating authority under the Prompt Payment and Construction Lien Act since 2023. The notice sets out the dispute and what you are claiming.
