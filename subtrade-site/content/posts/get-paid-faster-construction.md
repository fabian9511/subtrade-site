---
title: "Get paid faster in construction: a cash-flow playbook"
description: "A subcontractor's playbook for getting paid faster: bill clean, get holdback and retainage released, use the prompt-payment clock, and defend your draws."
blurb: "Getting paid faster is not about chasing invoices harder. It is about controlling the six levers that decide when the money actually lands."
tag: "Getting paid"
date: "2026-09-01"
image: "/subcontractor-cash-flow-getting-paid-faster-desk.webp"
imageAlt: "A subcontractor reviewing payment and holdback figures on a laptop at a site office desk with a calculator and construction drawings beside it."
---
...
Three things make a bill clean. A well-structured [schedule of values](/blog/schedule-of-values-subcontractors/) that breaks the contract into line items that bill without argument. A correctly filled [AIA G702 and G703 pay application](/blog/aia-g702-g703-pay-application-guide/), or its Canadian progress-draw equivalent, with the math tying cover to continuation sheet. And a running total that carries forward correctly every month, which is exactly what field-connected [progress billing](/construction-management-features/progress-billing/) protects that a drifting spreadsheet does not. Get the bill right and you have removed the most common reason payment is slow: rejection.
...
Two moves matter here. First, know the number. Run your withholding with the free [construction retainage calculator](/construction-retainage-calculator/) on US jobs or the [construction holdback calculator](/construction-holdback-calculator/) on Canadian ones, so you always know what is owed and when it comes due. The difference between the two systems is worth understanding, and we lay it out in [retainage vs. holdback](/blog/retainage-vs-holdback/). Second, chase the release actively. Holdback does not release itself, and the period after substantial completion is where money quietly gets stuck. If yours is late, [holdback release delays](/blog/holdback-release-delays/) walks through why, and what to do about it.

## Lever 3: Use the statutory payment clock

You may have more legal leverage than you are using. Prompt-payment legislation now sets hard deadlines for how long a payer can sit on a proper invoice before they owe you, with interest running if they miss it. In Alberta, for example, [prompt-payment rules](https://www.alberta.ca/prompt-payment-rules-for-construction-industry) give an owner 28 calendar days to pay a proper invoice and a contractor 7 days to pay its subs after being paid.

The catch is that the clock only starts when you submit a proper invoice, correctly. That is why levers 1 and 3 work together: clean billing is what arms the statutory deadline. The rules and the dates are covered in our guide to [Canadian prompt-payment rules](/blog/canada-prompt-payment-2026/). Knowing them changes the conversation from asking for payment to invoking a deadline.
...
It is deliberately quick, measured in weeks, and it exists precisely so a sub does not have to finance a dispute out of its own cash flow. When a draw is being unreasonably withheld, [construction adjudication in Canada](/blog/construction-adjudication-canada/) explains how the process works and when it is the right tool to reach for.
...
The defense is documentation: dated photos, marked-up drawings, and daily logs that show the condition you actually left. A back charge you can refute with a record gets reversed; one you cannot gets paid whether it was fair or not. [Construction back charges](/blog/construction-back-charges/) covers how to protect your draws from unjustified deductions.
