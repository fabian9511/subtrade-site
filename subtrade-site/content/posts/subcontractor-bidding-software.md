...
tag: "Estimating"
date: "2026-08-07"
image: "/subcontractor-bidding-software-pipeline-board.webp"
imageAlt: "An estimator reviewing a board of active bid invitations by stage on a laptop in a contractor's office, with drawings and a phone on the desk."
---
...
1. **Invitation** — an ITB lands. Which project, which GC, what scope, when's it due.
2. **Bid / no-bid** — a deliberate decision to pursue it or pass, made on purpose rather than by whichever email you happened to open.
3. **Estimate** — the ones you pursue get taken off and priced.
4. **Submitted** — the number goes out, on time, with the right qualifications attached.
5. **Follow-up** — you chase the GC for a decision instead of waiting by the phone.
6. **Won / lost** — and, critically, *why*, recorded so it teaches you something.
