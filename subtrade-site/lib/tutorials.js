...
//
// uploaded: the day the video went up on YouTube, as YYYY-MM-DD. It becomes the
// `uploadDate` in the VideoObject markup, which Google requires and which has to
// be true — this is a factual claim about the video, not a formatting detail.
//
// !! THESE ARE PLACEHOLDERS. Every one currently reads 2026-01-01, inherited
// !! from a single hard-coded date that used to cover all twelve tutorials.
// !! Read the real dates off YouTube Studio and replace them. The page picks up
// !! the change on its own; nothing else needs editing.
